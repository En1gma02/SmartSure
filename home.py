...
def home_page():
    ...
    image_url = "https://raw.githubusercontent.com/En1gma02/SmartSure/refs/heads/main/images/SmartSure_logo.png"
    st.markdown(f"""
    ...
    <ul class='action-list'>
        <li>Interact with PolicyPal AI Assistant</li>
    ...
    """, unsafe_allow_html=True)
    st.markdown("---")
    st.markdown("<p class='footer'>Made with ☕ and 💻 by Akshansh Dwivedi for Finovate Hacks</p>", unsafe_allow_html=True)
